...
class PerfCounter:
    def __init__(self):
        ...
        self.coreCMD="perf kvm --guest stat -a  -A  -x, -e LLC-load-misses -e cpu-cycles -e instructions -e cache-misses sleep 300"
    ...
    def probe(self):
       ...
       # outputNNC_perf_loop_all=self.runCommand(self.numaConnectCMD[0])
        ...
        outputPhysicalCore=self.runCommand(self.coreCMD)
